...
import oberon.model.players.Potions;
	...
	**/
	...
	public void levelUp(int skill) {
		...
		switch(skill) {
	        ...
	        sendFrame126("Your ranged level is now "+getLevelForXP(c.playerXP[skill])+".", 4445);
	...
	public void removeObjects() {
		objectToRemove(2956, 3212);//Rimmington Fountain
	...
	public void handleGamesNecklace(int ringId) {
		c.dialogueId = 38;
		c.getDH().sendDialogues(c.dialogueId, 0);
		c.usingNecklace = true;
	}
	...
	public void addStarter() {
		...
		sendFrame126("Welcome to Oberon!", 6248);
		c.getDH().sendDialogues(129, 945);
	}
	...
	public void handleLoginText() {
		...
		c.getPA().sendFrame126("Lumbridge", 13047);
		...
		c.getPA().sendFrame126("Varrock", 1300);
		c.getPA().sendFrame126("Lumbridge", 1325);
		c.getPA().sendFrame126("Falador", 1350);
		c.getPA().sendFrame126("Camelot", 1382);
