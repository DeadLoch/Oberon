...
import oberon.util.ISAACRandomGen;
...
public abstract class Player {
	...
	public int log = -1;
	public int[] quest = new int[Config.AMOUNT_OF_QUESTS];
...
public final int[][] MAGIC_SPELLS = { 
	...
	public boolean usingNecklace = false;
	...
	protected void appendPlayerAppearance(Stream str) {
		synchronized(this) {
			...
			playerProps.writeWord(difficultyRank);	
