...
public class Config {
	...
	public static final int START_LOCATION_X = 3495; // start here
	public static final int START_LOCATION_Y = 3485;
	public static final int RESPAWN_X = 3495; // when dead respawn here
	 ...
	 * Glory
	 */
	public static final int EDGEVILLE_X = 3495;
	public static final int EDGEVILLE_Y = 3485;
	...
	*Quests
	*/
	public static final int AMOUNT_OF_QUESTS = 1;
